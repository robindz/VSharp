...
{
    public class NewUploadEventArgs : EventArgs
    {
        ...
        public NewUploadEventArgs(int videoSeq, int pickSortOrder, int playTimeInSeconds, long playCount, long likeCount, long commentCount, string videoType,
